            ...
            <b-container fluid>
                <b-row class="mb-2">
                    ...
                    <b-col sm="6" style="margin-top: 8px;">
                        <router-link to='/permission/add' class="btn btn-info float-right">
            ...
            <table class="table table-bordered"  ref="formContainer">
                 <thead>
                    <tr>
                        ...
                        <th>
                            <span class="cursor-pointer" @click="sort('name')">Capabilty Name 
                                <i class="fa fa-sort float-right"></i>
                            </span>
                        </th>
                        <th width="200">
                ...
                <tbody v-if="list_data.length">
                    <tr v-for="row in list_data" :key="row.id">
                        ...
                        <router-link :to="'permission/edit/' + row.id" class="btn btn-success">
    ...
    export default {
        ...
        methods: {
            ...
            browse: function () {
                ...
                axios.get('permissions?' + $.param(this.search_data))
                .then(res => {
                    loader.hide();
            ...
            delete_by_id: function (id) {
                ...
                .then((dialog) => {
                    axios.post('permission/delete/' + id)
                    .then(response => {
                        this.browse();
                        dialog.close();
                    });
